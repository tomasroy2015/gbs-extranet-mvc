...
{
    public class TB_TypeDataController : Controller
    {
        //
        // GET: /TB_TypeData/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeDataRepository modelRepo = new TB_TypeDataRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeDataExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeDataExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeDataExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
