...
{
    public class TB_ReservationStatusHistoryController : Controller
    {
        //
        // GET: /TB_ReservationStatusHistory/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_ReservationStatusHistoryRepository modelRepo = new TB_ReservationStatusHistoryRepository();
