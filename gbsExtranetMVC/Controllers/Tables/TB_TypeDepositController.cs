...
{
    public class TB_TypeDepositController : Controller
    {
        //
        // GET: /TB_TypeDeposit/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeDepositRepository modelRepo = new TB_TypeDepositRepository();
                 result = modelRepo.GetAllTypeDeposit(TableID).ToDataSourceResult(request);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeDepositExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeDepositExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeDepositExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
