...
{
    public class TB_HotelCreditCardController : Controller
    {
        //
        // GET: /TB_HotelCreditCard/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_HotelCreditCardRepository modelRepo = new TB_HotelCreditCardRepository();
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_HotelCreditCardExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_HotelCreditCardExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_HotelCreditCardExt model)
        {
            string Msg = "";
            try
            {
