...
{
    public class TB_TypeHotelController : Controller
    {
        //
        // GET: /TB_TypeHotel/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeHotelRepository modelRepo = new TB_TypeHotelRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeHotelExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeHotelExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeHotelExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
