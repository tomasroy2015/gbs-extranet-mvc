...
{
    public class BizTbl_TableSecurityGroupRightController : Controller
    {
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                BizTbl_TableSecurityGroupRightRepository modelRepo = new BizTbl_TableSecurityGroupRightRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, BizTbl_TableSecurityGroupRightExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, BizTbl_TableSecurityGroupRightExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, BizTbl_TableSecurityGroupRightExt model)
        {
        ...
        #endregion
        public JsonResult _ReadSecurityGroup()
        {


            BizTbl_TableSecurityGroupRightRepository obj = new BizTbl_TableSecurityGroupRightRepository();

            // DataSourceResult result = ListOfModel.ToDataSourceResult(request);

            return Json(obj.SecurityGroup(), JsonRequestBehavior.AllowGet);
        }
