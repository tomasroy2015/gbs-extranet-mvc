...
{
    public class TB_HotelReservationPromotionController : Controller
    {
        //
        // GET: /TB_HotelReservationPromotion/
        ...
        public ActionResult Index()
        {
          ...
          public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
         {
            ...
            try
            {
                TB_HotelReservationPromotionRepository modelRepo = new TB_HotelReservationPromotionRepository();
