...
{
    public class TB_TypeFirmRequestStatusController : Controller
    {
        //
        // GET: /TB_TypeFirmRequestStatus/
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeFirmRequestStatusExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeFirmRequestStatusExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
