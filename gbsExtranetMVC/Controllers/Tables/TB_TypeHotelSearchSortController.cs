...
{
    public class TB_TypeHotelSearchSortController : Controller
    {
        //
        // GET: /TB_TypeHotelSearchSort/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeHotelSearchSortRepository modelRepo = new TB_TypeHotelSearchSortRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeHotelSearchSortExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeHotelSearchSortExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeHotelSearchSortExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
