...
{
    public class TB_HotelRoomAttributeController : Controller
    {
        //
        // GET: /TB_HotelRoomAttribute/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_HotelRoomAttributeRepository modelRepo = new TB_HotelRoomAttributeRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_HotelRoomAttributeExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_HotelRoomAttributeExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_HotelRoomAttributeExt model)
        {
