...
{
    public class TB_TypeMessageStatusController : Controller
    {
        //
        // GET: /TB_TypeMessageStatus/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeMessageStatusRepository modelRepo = new TB_TypeMessageStatusRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeMessageStatusExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeMessageStatusExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeMessageStatusExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
