...
{
    public class TB_HotelComissionController : Controller
    {
        //
        // GET: /TB_HotelComission/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_HotelComissionRepository modelRepo = new TB_HotelComissionRepository();
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_HotelComissionExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_HotelComissionExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_HotelComissionExt model)
        {
            string Msg = "";
            try
            {
