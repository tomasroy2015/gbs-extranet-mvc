...
{
    public class TB_HotelRoomBedHistoryController : Controller
    {
        //
        // GET: /TB_HotelRoomBedHistory/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_HotelRoomBedHistoryRepository modelRepo = new TB_HotelRoomBedHistoryRepository();
