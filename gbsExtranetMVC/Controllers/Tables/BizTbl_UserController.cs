...
{
    public class BizTbl_UserController : Controller
    {
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, BizTbl_UserExt model)
        {
            string Msg = "";
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, BizTbl_UserExt model)
        {
            string Msg = "";
            try
            {
