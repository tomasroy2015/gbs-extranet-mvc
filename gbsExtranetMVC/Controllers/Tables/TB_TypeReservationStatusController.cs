...
{
    public class TB_TypeReservationStatusController : Controller
    {
        //
        // GET: /TB_TypeReservationStatus/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeReservationStatusRepository modelRepo = new TB_TypeReservationStatusRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeReservationStatusExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeReservationStatusExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeReservationStatusExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
