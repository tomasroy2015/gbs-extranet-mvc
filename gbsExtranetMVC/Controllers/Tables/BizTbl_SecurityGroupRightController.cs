...
{
    public class BizTbl_SecurityGroupRightController : Controller
    {
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                BizTbl_SecurityGroupRightRepository modelRepo = new BizTbl_SecurityGroupRightRepository();
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, BizTbl_SecurityGroupRightExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, BizTbl_SecurityGroupRightExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, BizTbl_SecurityGroupRightExt model)
        {
            string Msg = "";
            try
            {
