...
{
    public class TB_BusinessPartnerRegionController : Controller
    {
        //
        // GET: /TB_BusinessPartnerRegion/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_BusinessPartnerRegionRepository modelRepo = new TB_BusinessPartnerRegionRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_BusinessPartnerRegionExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_BusinessPartnerRegionExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_BusinessPartnerRegionExt model)
        {
