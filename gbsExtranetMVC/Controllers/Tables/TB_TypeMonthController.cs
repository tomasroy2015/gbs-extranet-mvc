...
{
    public class TB_TypeMonthController : Controller
    {
        //
        // GET: /TB_TypeMonth/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeMonthRepository modelRepo = new TB_TypeMonthRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeMonthExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeMonthExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeMonthExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
