...
{
    public class TB_BusinessPartnerPaxController : Controller
    {
        //
        // GET: /TB_BusinessPartnerPax/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_BusinessPartnerPaxRepository modelRepo = new TB_BusinessPartnerPaxRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_BusinessPartnerPaxExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_BusinessPartnerPaxExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_BusinessPartnerPaxExt model)
        {
