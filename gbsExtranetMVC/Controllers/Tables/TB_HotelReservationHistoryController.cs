...
{
    public class TB_HotelReservationHistoryController : Controller
    {
        //
        // GET: /TB_HotelReservationHistory/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_HotelReservationHistoryRepository modelRepo = new TB_HotelReservationHistoryRepository();
