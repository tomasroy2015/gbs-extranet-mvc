...
{
    public class TB_HotelReservationRateHistoryController : Controller
    {
        //
        // GET: /TB_HotelReservationRateHistory/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_HotelReservationRateHistoryRepository modelRepo = new TB_HotelReservationRateHistoryRepository();
