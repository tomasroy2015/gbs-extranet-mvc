...
{
    public class TB_TypeDayController : Controller
    {
        //
        // GET: /TB_TypeDay/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeDayRepository modelRepo = new TB_TypeDayRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeDayExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeDayExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeDayExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
