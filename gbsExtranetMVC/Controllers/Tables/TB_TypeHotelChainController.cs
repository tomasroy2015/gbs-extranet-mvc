...
{
    public class TB_TypeHotelChainController : Controller
    {
        //
        // GET: /TB_TypeHotelChain/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeHotelChainRepository modelRepo = new TB_TypeHotelChainRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeHotelChainExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeHotelChainExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeHotelChainExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
