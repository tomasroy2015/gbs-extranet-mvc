...
{
    public class TB_TypeOperationController : Controller
    {
        //
        // GET: /TB_TypeOperation/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeOperationRepository modelRepo = new TB_TypeOperationRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeOperationExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeOperationExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeOperationExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
