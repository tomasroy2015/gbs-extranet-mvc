...
{
    public class TB_BusinessPartnerCancelPolicyController : Controller
    {
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_BusinessPartnerCancelPolicyRepository modelRepo = new TB_BusinessPartnerCancelPolicyRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_BusinessPartnerCancelPolicyExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_BusinessPartnerCancelPolicyExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_BusinessPartnerCancelPolicyExt model)
        {
