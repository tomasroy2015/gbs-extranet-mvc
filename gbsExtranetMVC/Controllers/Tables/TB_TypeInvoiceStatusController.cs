...
{
    public class TB_TypeInvoiceStatusController : Controller
    {
        //
        // GET: /TB_TypeInvoiceStatus/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeInvoiceStatusRepository modelRepo = new TB_TypeInvoiceStatusRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeInvoiceStatusExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeInvoiceStatusExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeInvoiceStatusExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
