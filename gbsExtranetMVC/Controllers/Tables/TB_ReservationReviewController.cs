...
{
    public class TB_ReservationReviewController : Controller
    {
        //
        // GET: /TB_ReservationReview/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_ReservationReviewRepository modelRepo = new TB_ReservationReviewRepository();
