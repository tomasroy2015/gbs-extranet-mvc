...
{
    public class TB_TypeMessageSubjectController : Controller
    {
        //
        // GET: /TB_TypeMessageSubject/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeMessageSubjectRepository modelRepo = new TB_TypeMessageSubjectRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeMessageSubjectExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeMessageSubjectExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeMessageSubjectExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
