...
{
    public class TB_ChannelManagerController : Controller
    {
        //
        // GET: /TB_ChannelManager/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_ChannelManagerRepository modelRepo = new TB_ChannelManagerRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_ChannelManagerExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_ChannelManagerExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_ChannelManagerExt model)
        {
