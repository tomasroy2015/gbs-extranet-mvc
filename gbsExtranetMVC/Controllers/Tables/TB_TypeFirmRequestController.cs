...
{
    public class TB_TypeFirmRequestController : Controller
    {
        //
        // GET: /TB_TypeFirmRequest/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeFirmRequestRepository modelRepo = new TB_TypeFirmRequestRepository();
                 result = modelRepo.GetAllTypeFirmRequest(TableID).ToDataSourceResult(request);
            }
            catch (Exception ex)
            {
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeFirmRequestExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeFirmRequestExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeFirmRequestExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
