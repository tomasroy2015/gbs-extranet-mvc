...
{
    public class TB_UnitController : Controller
    {
        //
        // GET: /TB_Unit/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_UnitRepository modelRepo = new TB_UnitRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_UnitExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_UnitExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_UnitExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
