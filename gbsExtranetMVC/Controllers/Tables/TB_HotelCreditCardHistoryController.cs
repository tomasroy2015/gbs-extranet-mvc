...
{
    public class TB_HotelCreditCardHistoryController : Controller
    {
        //
        // GET: /TB_HotelCreditCardHistory/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_HotelCreditCardHistoryRepository modelRepo = new TB_HotelCreditCardHistoryRepository();
