...
{
    public class TB_TypeSalutationController : Controller
    {
        //
        // GET: /TB_TypeSalutation/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeSalutationRepository modelRepo = new TB_TypeSalutationRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeSalutationExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeSalutationExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeSalutationExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
