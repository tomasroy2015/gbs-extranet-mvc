...
{
    public class TB_AttributeHeaderController : Controller
    {
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_AttributeHeaderRepository modelRepo = new TB_AttributeHeaderRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_AttributeHeaderExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_AttributeHeaderExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_AttributeHeaderExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
