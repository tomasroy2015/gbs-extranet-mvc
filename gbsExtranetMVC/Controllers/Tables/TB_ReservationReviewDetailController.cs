...
{
    public class TB_ReservationReviewDetailController : Controller
    {
        //
        // GET: /TB_ReservationReviewDetail/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_ReservationReviewDetailRepository modelRepo = new TB_ReservationReviewDetailRepository();
