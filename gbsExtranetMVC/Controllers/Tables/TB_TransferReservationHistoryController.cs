...
{
    public class TB_TransferReservationHistoryController : Controller
    {
        //
        // GET: /TB_TransferReservationHistory/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TransferReservationHistoryRepository modelRepo = new TB_TransferReservationHistoryRepository();
