...
{
    public class TB_TypeReviewEvaluationController : Controller
    {
        //
        // GET: /TB_TypeReviewEvaluation/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeReviewEvaluationRepository modelRepo = new TB_TypeReviewEvaluationRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeReviewEvaluationExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeReviewEvaluationExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeReviewEvaluationExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
