...
{
    public class TB_TypePenaltyRateController : Controller
    {
        //
        // GET: /TB_TypePenaltyRate/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypePenaltyRateRepository modelRepo = new TB_TypePenaltyRateRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypePenaltyRateExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypePenaltyRateExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypePenaltyRateExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
