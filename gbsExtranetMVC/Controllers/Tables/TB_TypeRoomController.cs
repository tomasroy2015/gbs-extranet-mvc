...
{
    public class TB_TypeRoomController : Controller
    {
        //
        // GET: /TB_TypeRoom/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeRoomRepository modelRepo = new TB_TypeRoomRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeRoomExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeRoomExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeRoomExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
