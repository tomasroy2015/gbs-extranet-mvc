...
{
    public class TB_HotelPromotionHistoryController : Controller
    {
        //
        // GET: /TB_HotelPromotionHistory/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_HotelPromotionHistoryRepository modelRepo = new TB_HotelPromotionHistoryRepository();
