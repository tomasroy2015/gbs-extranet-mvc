...
{
    public class TB_TourAttributeController : Controller
    {
        //
        // GET: /TB_TourAttribute/
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TourAttributeExt model)
        {
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TourAttributeExt model)
        {
            string Msg = "";
            try
            {
