...
{
    public class TB_TypeSmokingController : Controller
    {
        //
        // GET: /TB_TypeSmoking/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeSmokingRepository modelRepo = new TB_TypeSmokingRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeSmokingExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeSmokingExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeSmokingExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
