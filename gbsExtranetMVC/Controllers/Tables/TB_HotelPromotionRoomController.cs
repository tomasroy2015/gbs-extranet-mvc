...
{
    public class TB_HotelPromotionRoomController : Controller
    {
        //
        // GET: /TB_HotelPromotionRoom/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_HotelPromotionRoomRepository modelRepo = new TB_HotelPromotionRoomRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_HotelPromotionRoomExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_HotelPromotionRoomExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_HotelPromotionRoomExt model)
        {
