...
namespace gbsExtranetMVC.Controllers.Tables
{
    public class TB_PhotoController : Controller
    {
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_PhotoRepository modelRepo = new TB_PhotoRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_PhotoExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_PhotoExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_PhotoExt model)
        {
