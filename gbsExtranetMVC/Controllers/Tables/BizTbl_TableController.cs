...
{
    public class BizTbl_TableController : Controller
    {
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                BizTbl_TableRepository modelRepo = new BizTbl_TableRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, BizTbl_TableExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, BizTbl_TableExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, BizTbl_TableExt model)
        {
