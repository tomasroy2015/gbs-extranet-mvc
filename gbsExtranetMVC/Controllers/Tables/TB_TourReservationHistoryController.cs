...
{
    public class TB_TourReservationHistoryController : Controller
    {
        //
        // GET: /TB_TourReservationHistory/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TourReservationHistoryRepository modelRepo = new TB_TourReservationHistoryRepository();
