...
{
    public class TB_TypeReviewStatusController : Controller
    {
        //
        // GET: /TB_TypeReviewStatus/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeReviewStatusRepository modelRepo = new TB_TypeReviewStatusRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeReviewStatusExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeReviewStatusExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeReviewStatusExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
