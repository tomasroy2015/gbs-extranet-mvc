...
{
    public class TB_TypeBusinessPartnerController : Controller
    {
        //
        // GET: /TB_TypeBusinessPartner/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeBusinessPartnerRepository modelRepo = new TB_TypeBusinessPartnerRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeBusinessPartnerExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeBusinessPartnerExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeBusinessPartnerExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
