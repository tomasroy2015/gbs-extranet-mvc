...
{
    public class TB_FirmRequestHistoryController : Controller
    {
        //
        // GET: /TB_FirmRequestHistory/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                ...
                TB_FirmRequestHistoryRepository modelRepo = new TB_FirmRequestHistoryRepository();
