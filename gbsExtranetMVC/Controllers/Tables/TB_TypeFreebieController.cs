...
{
    public class TB_TypeFreebieController : Controller
    {
        //
        // GET: /TB_TypeFreebie/
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeFreebieExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeFreebieExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeFreebieExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
