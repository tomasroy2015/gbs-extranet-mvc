...
{
    public class TB_TypePricePolicyController : Controller
    {
        //
        // GET: /TB_TypePricePolicy/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypePricePolicyRepository modelRepo = new TB_TypePricePolicyRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypePricePolicyExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypePricePolicyExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypePricePolicyExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
