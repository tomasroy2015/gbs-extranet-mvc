...
{
    public class TB_HotelAttributeHistoryController : Controller
    {
        //
        // GET: /TB_HotelAttributeHistory/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_HotelAttributeHistoryRepository modelRepo = new TB_HotelAttributeHistoryRepository();
