...
{
    public class BizTbl_PageControlController : Controller
    {
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                BizTbl_PageControlRepository modelRepo = new BizTbl_PageControlRepository();
        ...
        //public ActionResult _Create([DataSourceRequest]DataSourceRequest request, BizTbl_PageControlExt model)
        //{
        //    string Msg = "";
        //    try
        //    {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, BizTbl_PageControlExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, BizTbl_PageControlExt model)
        {
