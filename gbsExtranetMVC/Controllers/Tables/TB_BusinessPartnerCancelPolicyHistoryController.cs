...
{
    public class TB_BusinessPartnerCancelPolicyHistoryController : Controller
    {
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_BusinessPartnerCancelPolicyHistoryRepository modelRepo = new TB_BusinessPartnerCancelPolicyHistoryRepository();
