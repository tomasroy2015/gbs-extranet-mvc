...
{
    public class BizTbl_MailQueueController : Controller
    {
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
              ...
              try
              {
                  BizTbl_MailQueueRepository modelRepo = new BizTbl_MailQueueRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, BizTbl_MailQueueExt model)
        {
            string Msg = "";
            try
            {
        ...
        //public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, BizTbl_MailQueueExt model)
        //{
        //    string Msg = "";
        //    try
        //    {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, BizTbl_MailQueueExt model)
        {
