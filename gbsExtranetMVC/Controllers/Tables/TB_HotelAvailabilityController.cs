...
{
    public class TB_HotelAvailabilityController : Controller
    {
        //
        // GET: /TB_HotelAvailability/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_HotelAvailabilityRepository modelRepo = new TB_HotelAvailabilityRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_HotelAvailabilityExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_HotelAvailabilityExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_HotelAvailabilityExt model)
        {
