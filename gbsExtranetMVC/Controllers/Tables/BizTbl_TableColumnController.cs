...
{
    public class BizTbl_TableColumnController : Controller
    {
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                BizTbl_TableColumnRepository modelRepo = new BizTbl_TableColumnRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, BizTbl_TableColumnExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, BizTbl_TableColumnExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, BizTbl_TableColumnExt model)
        {
        ...
        public JsonResult _ReadPart()
        {
            ...
            BizTbl_TableColumnRepository obj = new BizTbl_TableColumnRepository();

            // DataSourceResult result = ListOfModel.ToDataSourceResult(request);

            return Json(obj.GetTableValue(), JsonRequestBehavior.AllowGet);
        }
