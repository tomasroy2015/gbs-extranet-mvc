...
{
    public class TB_HotelCancelPolicyController : Controller
    {
        //
        // GET: /TB_HotelCancelPolicy/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_HotelCancelPolicyRepository modelRepo = new TB_HotelCancelPolicyRepository();
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_HotelCancelPolicyExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_HotelCancelPolicyExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_HotelCancelPolicyExt model)
        {
            string Msg = "";
            try
            {
