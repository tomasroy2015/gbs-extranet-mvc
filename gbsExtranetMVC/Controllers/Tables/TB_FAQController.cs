...
{
    public class TB_FAQController : Controller
    {
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_FAQRepository modelRepo = new TB_FAQRepository();
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_FAQExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_FAQExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_FAQExt model)
        {
            string Msg = "";
            try
            {
