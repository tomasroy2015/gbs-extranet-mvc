...
{
    public class TB_TourController : Controller
    {
        //
        // GET: /TB_Tour/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TourRepository modelRepo = new TB_TourRepository();
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TourExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TourExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TourExt model)
        {
            string Msg = "";
            try
            {
