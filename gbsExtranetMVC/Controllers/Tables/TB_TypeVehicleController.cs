...
{
    public class TB_TypeVehicleController : Controller
    {
        //
        // GET: /TB_TypeVehicle/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeVehicleRepository modelRepo = new TB_TypeVehicleRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeVehicleExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeVehicleExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeVehicleExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
