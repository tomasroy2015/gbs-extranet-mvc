...
{
    public class TB_TypeHotelBudgetController : Controller
    {
        //
        // GET: /TB_TypeHotelBudget/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeHotelBudgetRepository modelRepo = new TB_TypeHotelBudgetRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeHotelBudgetExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeHotelBudgetExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeHotelBudgetExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
