...
{
    public class TB_TransferPeriodController : Controller
    {
        //
        // GET: /TB_TransferPeriod/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TransferPeriodRepository modelRepo = new TB_TransferPeriodRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TransferPeriodExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TransferPeriodExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TransferPeriodExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
