...
{
    public class TB_TypeCancelController : Controller
    {
        //
        // GET: /TB_TypeCancel/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeCancelRepository modelRepo = new TB_TypeCancelRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeCancelExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeCancelExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeCancelExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
