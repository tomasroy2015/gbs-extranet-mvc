...
{
    public class BizTbl_SecurityController : Controller
    {
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                BizTbl_SecurityRepository modelRepo = new BizTbl_SecurityRepository();
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, BizTbl_SecurityExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, BizTbl_SecurityExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, BizTbl_SecurityExt model)
        {
            string Msg = "";
            try
            {
