...
{
    public class TB_TypeBedController : Controller
    {
        //
        // GET: /TB_TypeBed/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeBedRepository modelRepo = new TB_TypeBedRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeBedExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeBedExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeBedExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
