...
{
    public class TB_TypeStatusController : Controller
    {
        //
        // GET: /TB_TypeStatus/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeStatusRepository modelRepo = new TB_TypeStatusRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeStatusExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeStatusExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeStatusExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
