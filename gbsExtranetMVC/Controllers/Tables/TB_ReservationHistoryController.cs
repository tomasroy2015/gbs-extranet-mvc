...
{
    public class TB_ReservationHistoryController : Controller
    {
        //
        // GET: /TB_ReservationHistory/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_ReservationHistoryRepository modelRepo = new TB_ReservationHistoryRepository();
