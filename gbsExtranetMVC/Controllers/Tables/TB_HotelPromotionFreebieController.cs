...
{
    public class TB_HotelPromotionFreebieController : Controller
    {
        //
        // GET: /TB_HotelPromotionFreebie/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_HotelPromotionFreebieRepository modelRepo = new TB_HotelPromotionFreebieRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_HotelPromotionFreebieExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_HotelPromotionFreebieExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_HotelPromotionFreebieExt model)
        {
