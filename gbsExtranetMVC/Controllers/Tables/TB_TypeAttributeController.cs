...
{
    public class TB_TypeAttributeController : Controller
    {
        //
        // GET: /TB_TypeAttribute/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeAttributeRepository modelRepo = new TB_TypeAttributeRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeAttributeExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeAttributeExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeAttributeExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
