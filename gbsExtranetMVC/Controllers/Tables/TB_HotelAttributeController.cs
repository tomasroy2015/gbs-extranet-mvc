...
{
    public class TB_HotelAttributeController : Controller
    {
        //
        // GET: /TB_HotelAttribute/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_HotelAttributeRepository modelRepo = new TB_HotelAttributeRepository();
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_HotelAttributeExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_HotelAttributeExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_HotelAttributeExt model)
        {
            string Msg = "";
            try
            {
