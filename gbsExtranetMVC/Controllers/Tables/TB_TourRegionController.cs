...
using gbsExtranetMVC.Models.Repositories.Tables;
...
{
    public class TB_TourRegionController : Controller
    {
        //
        // GET: /TB_TourRegion/
        ...
        #region Read, Create, Update, Destroy
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            DataSourceResult result = null;
            try
            {
                TB_TourRegionRepository modelRepo = new TB_TourRegionRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TourRegionExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TourRegionExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TourRegionExt model)
        {
