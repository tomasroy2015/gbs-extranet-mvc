...
{
    public class TB_BusinessPartnerPaxHistoryController : Controller
    {
        //
        // GET: /TB_BusinessPartnerPaxHistory/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_BusinessPartnerPaxHistoryRepository modelRepo = new TB_BusinessPartnerPaxHistoryRepository();
