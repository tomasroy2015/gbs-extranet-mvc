...
{
    public class BizTbl_MessageController : Controller
    {
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                BizTbl_MessageRepository modelRepo = new BizTbl_MessageRepository();
        ...
        [ValidateInput(false)]
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, BizTbl_MessageExt model)
        {
            string Msg = "";
            try
            {
        ...
        [ValidateInput(false)]
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, BizTbl_MessageExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, BizTbl_MessageExt model)
        {
