...
{
    public class TB_HotelCancelPolicyHistoryController : Controller
    {
        //
        // GET: /TB_HotelCancelPolicyHistory/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                ...
                TB_HotelCancelPolicyHistoryRepository modelRepo = new TB_HotelCancelPolicyHistoryRepository();
