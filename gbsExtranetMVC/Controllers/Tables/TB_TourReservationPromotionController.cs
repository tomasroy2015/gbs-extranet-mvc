...
{
    public class TB_TourReservationPromotionController : Controller
    {
        //
        // GET: /TB_TourReservationPromotion/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TourReservationPromotionRepository modelRepo = new TB_TourReservationPromotionRepository();
