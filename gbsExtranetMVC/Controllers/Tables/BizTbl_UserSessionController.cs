...
{
    public class BizTbl_UserSessionController : Controller
    {
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                BizTbl_UserSessionRepository modelRepo = new BizTbl_UserSessionRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, BizTbl_UserSessionExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, BizTbl_UserSessionExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, BizTbl_UserSessionExt model)
        {
