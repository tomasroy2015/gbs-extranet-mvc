...
{
    public class TB_TypeHotelClassController : Controller
    {
        //
        // GET: /TB_TypeHotelClass/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeHotelClassRepository modelRepo = new TB_TypeHotelClassRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeHotelClassExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeHotelClassExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeHotelClassExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
