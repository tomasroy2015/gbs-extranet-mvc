...
{
    public class TB_InvoiceDetailHistoryController : Controller
    {
        //
        // GET: /TB_InvoiceDetailHistory/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_InvoiceDetailHistoryRepository modelRepo = new TB_InvoiceDetailHistoryRepository();
