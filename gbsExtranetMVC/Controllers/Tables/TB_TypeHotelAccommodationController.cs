...
{
    public class TB_TypeHotelAccommodationController : Controller
    {
        //
        // GET: /TB_TypeHotelAccommodation/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeFreebieRepository modelRepo = new TB_TypeFreebieRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeHotelAccommodationExt model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    TB_TypeHotelAccommodationRepository modelRepo = new TB_TypeHotelAccommodationRepository();
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeHotelAccommodationExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeHotelAccommodationExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
