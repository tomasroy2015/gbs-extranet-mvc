...
{
    public class TB_BusinessPartnerHistoryController : Controller
    {
        //
        // GET: /TB_BusinessPartnerHistory/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_BusinessPartnerHistoryRepository modelRepo = new TB_BusinessPartnerHistoryRepository();
