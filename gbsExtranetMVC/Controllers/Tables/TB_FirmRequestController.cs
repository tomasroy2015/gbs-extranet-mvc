...
{
    public class TB_FirmRequestController : Controller
    {
        //
        // GET: /TB_FirmRequest/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_FirmRequestRepository modelRepo = new TB_FirmRequestRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_FirmRequestExt model)
        {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_FirmRequestExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_FirmRequestExt model)
        {
            string Msg = "";
            try
            {
