...
{
    public class TB_TypeSubRegionController : Controller
    {
        //
        // GET: /TB_TypeSubRegion/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeSubRegionRepository modelRepo = new TB_TypeSubRegionRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeSubRegionExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeSubRegionExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeSubRegionExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
