...
{
    public class TB_TypeReservationOperationController : Controller
    {
        //
        // GET: /TB_TypeReservationOperation/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeReservationOperationRepository modelRepo = new TB_TypeReservationOperationRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeReservationOperationExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeReservationOperationExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeReservationOperationExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
