...
{
    public class TB_HotelReservationRateController : Controller
    {
        //
        // GET: /TB_HotelReservationRate/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_HotelReservationRateRepository modelRepo = new TB_HotelReservationRateRepository();
