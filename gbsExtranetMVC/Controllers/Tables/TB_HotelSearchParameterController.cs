...
{
    public class TB_HotelSearchParameterController : Controller
    {
        //
        // GET: /TB_HotelSearchParameter/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_HotelSearchParameterRepository modelRepo = new TB_HotelSearchParameterRepository();
