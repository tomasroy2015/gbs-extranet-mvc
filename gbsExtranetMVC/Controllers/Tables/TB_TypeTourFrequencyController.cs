...
{
    public class TB_TypeTourFrequencyController : Controller
    {
        //
        // GET: /TB_TypeTourFrequency/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeTourFrequencyRepository modelRepo = new TB_TypeTourFrequencyRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeTourFrequencyExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeTourFrequencyExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeTourFrequencyExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
