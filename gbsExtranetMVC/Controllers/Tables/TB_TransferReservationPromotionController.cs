...
{
    public class TB_TransferReservationPromotionController : Controller
    {
        //
        // GET: /TB_TransferReservationPromotion/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TransferReservationPromotionRepository modelRepo = new TB_TransferReservationPromotionRepository();
