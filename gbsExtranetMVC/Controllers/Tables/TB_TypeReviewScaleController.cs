...
{
    public class TB_TypeReviewScaleController : Controller
    {
        //
        // GET: /TB_TypeReviewScale/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeReviewScaleRepository modelRepo = new TB_TypeReviewScaleRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeReviewScaleExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeReviewScaleExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeReviewScaleExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
