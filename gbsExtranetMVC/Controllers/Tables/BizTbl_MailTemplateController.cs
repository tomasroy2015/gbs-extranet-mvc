...
{
    public class BizTbl_MailTemplateController : Controller
    {
      ...
      [gbsExtranetMVC.Helpers.Authorization(Permissions.AllUsers)]
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                BizTbl_MailTemplateRepository modelRepo = new BizTbl_MailTemplateRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, BizTbl_MailTemplateExt model)
        {
        ...
        [HttpPost, ValidateInput(false)]
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, BizTbl_MailTemplateExt model)
        {
            string Msg = "";
            try
            {
        ...
        [HttpPost, ValidateInput(false)]
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, BizTbl_MailTemplateExt model)
        {
