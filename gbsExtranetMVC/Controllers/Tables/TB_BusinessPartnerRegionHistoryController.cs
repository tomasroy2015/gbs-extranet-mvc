...
{
    public class TB_BusinessPartnerRegionHistoryController : Controller
    {
        //
        // GET: /TB_BusinessPartnerRegionHistory/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_BusinessPartnerRegionHistoryRepository modelRepo = new TB_BusinessPartnerRegionHistoryRepository();
