...
{
    public class BizTbl_UserHotelController : Controller
    {
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                BizTbl_UserHotelRepository modelRepo = new BizTbl_UserHotelRepository();
        ...
        public JsonResult _ReadPart()
        {
            ...
            BizTbl_UserHotelRepository obj = new BizTbl_UserHotelRepository();
