...
{
    public class TB_HotelPromotionController : Controller
    {
        //
        // GET: /TB_HotelPromotion/
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_HotelPromotionExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_HotelPromotionExt model)
        {
