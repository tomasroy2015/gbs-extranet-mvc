...
{
    public class TB_HotelRegionController : Controller
    {
        //
        // GET: /TB_HotelRegion/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_HotelRegionRepository modelRepo = new TB_HotelRegionRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_HotelRegionExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_HotelRegionExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_HotelRegionExt model)
        {
