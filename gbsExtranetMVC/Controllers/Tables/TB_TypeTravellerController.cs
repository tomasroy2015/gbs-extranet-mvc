...
{
    public class TB_TypeTravellerController : Controller
    {
        //
        // GET: /TB_TypeTraveller/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeTravellerRepository modelRepo = new TB_TypeTravellerRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeTravellerExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeTravellerExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeTravellerExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
