...
{
    public class TB_PromotionController : Controller
    {
        //
        // GET: /TB_Promotion/
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_PromotionExt model)
        {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_PromotionExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
