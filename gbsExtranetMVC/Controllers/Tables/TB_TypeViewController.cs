...
{
    public class TB_TypeViewController : Controller
    {
        //
        // GET: /TB_TypeView/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeViewRepository modelRepo = new TB_TypeViewRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeViewExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeViewExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeViewExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
