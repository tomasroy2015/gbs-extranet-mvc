...
{
    public class TB_TypeReviewController : Controller
    {
        //
        // GET: /TB_TypeReview/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeReviewRepository modelRepo = new TB_TypeReviewRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeReviewExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeReviewExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeReviewExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
