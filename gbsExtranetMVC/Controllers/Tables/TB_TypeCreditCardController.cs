...
{
    public class TB_TypeCreditCardController : Controller
    {
        //
        // GET: /TB_TypeCreditCard/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_TypeCreditCardRepository modelRepo = new TB_TypeCreditCardRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_TypeCreditCardExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_TypeCreditCardExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_TypeCreditCardExt model)
        {
            if (ModelState.IsValid)
            {
                string Msg = "";
