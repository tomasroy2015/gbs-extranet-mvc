...
{
    public class TB_HotelRoomAttributeHistoryController : Controller
    {
        //
        // GET: /TB_HotelRoomAttributeHistory/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_HotelRoomAttributeHistoryRepository modelRepo = new TB_HotelRoomAttributeHistoryRepository();
