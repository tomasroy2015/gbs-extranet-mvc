...
{
    public class TB_ReservationReviewHistoryController : Controller
    {
        //
        // GET: /TB_ReservationReviewHistory/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_ReservationReviewHistoryRepository modelRepo = new TB_ReservationReviewHistoryRepository();
