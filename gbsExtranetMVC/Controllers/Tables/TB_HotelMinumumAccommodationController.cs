...
{
    public class TB_HotelMinumumAccommodationController : Controller
    {
        ...
        //
        // GET: /TB_HotelMinumumAccommodation/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_HotelMinumumAccommodationRepository modelRepo = new TB_HotelMinumumAccommodationRepository();
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_HotelMinumumAccommodationExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_HotelMinumumAccommodationExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_HotelMinumumAccommodationExt model)
        {
            string Msg = "";
            try
            {
