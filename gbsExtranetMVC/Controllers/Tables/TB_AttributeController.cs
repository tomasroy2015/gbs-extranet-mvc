...
{
    public class TB_AttributeController : Controller
    {
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_AttributeRepository modelRepo = new TB_AttributeRepository();
        ...
        public ActionResult _Create([DataSourceRequest]DataSourceRequest request, TB_AttributeExt model)
        {
        ...
        public ActionResult _Destroy([DataSourceRequest]DataSourceRequest request, TB_AttributeExt model)
        {
            string Msg = "";
            try
            {
        ...
        public ActionResult _Update([DataSourceRequest]DataSourceRequest request, TB_AttributeExt model)
        {
