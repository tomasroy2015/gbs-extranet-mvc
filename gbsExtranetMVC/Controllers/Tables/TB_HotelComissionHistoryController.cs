...
{
    public class TB_HotelComissionHistoryController : Controller
    {
        //
        // GET: /TB_HotelComissionHistory/
        ...
        public ActionResult _Read([DataSourceRequest]DataSourceRequest request, int TableID)
        {
            ...
            try
            {
                TB_HotelComissionHistoryRepository modelRepo = new TB_HotelComissionHistoryRepository();
