...
namespace gbsExtranetMVC.Controllers.Management
{
    ...
    public class ReviewsController : Controller
    {
        ...
        public JsonResult ReservationReviewStatusApprove(int ID)
        {
            string Msg = "";
            ...
            try
            {
              ...
              //  FirmRequestExt model = new FirmRequestExt();
                ...
                if (modelRepo.UpdateApproveStatus(ID,this) == false)
                {
        ...
        public JsonResult ReservationReviewStatusReject(int ID)
        {
            string Msg = "";
            string request = "false";
            try
        ...
        //public JsonResult ReservationReviewStatusApprove(long ID)
        //{
        //    ReviewsRepository objupdate = new ReviewsRepository();
        //    int i = objupdate.UpdateReviewStatus(ID);
